...
<style>
  ...
  *:after {
  ...
  .darkTheme > div > div > section > h3 {
    transition: 300ms;
    color: gainsboro;
  }

  .darkTheme > div > div > section > div > h4 {
    transition: 300ms;
    color: gainsboro;
  }

  .darkTheme > div > div > section > div > p {
    transition: 300ms;
    color: gainsboro;
  }

  .darkTheme > div > div > section > div > ul {
    transition: 300ms;
    color: gainsboro;
  }
...
{#if visible}
  <div class:darkTheme>
    <div class="container">
      ...
      <div class="section-1">
        <section transition:fly={{ x: 30, delay: 220 }}>
          <h3>What I do</h3>
          <p>
            I am a
            <b>front-end</b>
            specialist. I love being part of cross-functional teams and being
            the
            <b>logical glue</b>
          ...
          <p>
            ...
            , so I am familiar with back-end tech (Node, Go, SQL databases). And
            I keep things interesting by learning Rust on the side!
          </p>
        </section>

        <section transition:fly={{ x: 30, delay: 300 }}>
      ...
      <div class="section-2">
        ...
        <section transition:fly={{ x: 30, delay: 320 }}>
          <h3>On the side</h3>
          <p>
          ...
          <ul class="list">
            <li class="list-item">
              <a
                title="Using React’s context API to provide a localization
                toolbox for your components"
          ...
          <ul class="list">
            ...
            <li class="list-item">
              <a
                title="A small app to check if a mysterious ingredient is
                actually not vegan"
