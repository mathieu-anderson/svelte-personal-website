...
<style>
  ...
  *:after {
  ...
  .pill-info {
    padding: 0.6em;
    /* background-color: hsl(53, 93%, 98%); */
    background-color: hsl("0, 0%, 0%");
    margin-left: 0.75em;
    border-right: 4px solid hsl(0, 0%, 20%);
    border-bottom: 4px solid hsl(0, 0%, 20%);
    /* border-right: 4px solid hsl(53, 93%, 48%);
    border-bottom: 4px solid hsl(53, 93%, 48%); */
  }
        ...
        <div class="pills">
          <div
            ...
            {#if showPillInfo.JavaScript}
              <div class="pill-info" transition:fly={{ y: -14, duration: 150 }}>
                <ul>
