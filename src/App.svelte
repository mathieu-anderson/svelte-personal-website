      ...
      <section class="section-3" transition:fly={{ x: 30, delay: 60 }}>
        ...
        <div class="pills">
          <div
            ...
            on:click={() => {
              showPillInfo !== 'JavaScript' ? (showPillInfo = 'JavaScript') : (showPillInfo = '');
            }}>
            <Pill
              name="JavaScript"
              ...
              color="53, 93%, 48%"
              {darkTheme} />
            {#if showPillInfo === 'JavaScript'}
              <div class="pill-info" transition:fly={{ y: -14 }}>
                <ul>
                  <li>
                    <b>Experience:</b>
                    3 years
                  ...
                  <li>
                    <b>What I love about it:</b>
                    the flexibility to be used in the front-end and the
          ...
          <div
            class="pill-container"
            on:click={() => {
              showPillInfo !== 'TypeScript' ? (showPillInfo = 'TypeScript') : (showPillInfo = '');
            }}>
            <Pill
              name="TypeScript"
              ...
              color="204, 100%, 40%"
              {darkTheme} />
            {#if showPillInfo === 'TypeScript'}
              <div class="pill-info" transition:fly={{ y: -14 }}>
                <ul>
                  <li>Experience: 1 years</li>
                  <li>
                    <b>What I love about it:</b>
                    everything JavaScript offers, but with type safety for a big
